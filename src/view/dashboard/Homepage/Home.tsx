        ...
        <div className="homeimg-text row   d-flex justify-content-between align-items-center  ">
          <div className="col-lg-7 col-md-7 col-12 m-0 p-0 ">
            <div className="d-flex h-100 mt-lg-5 mt-md-5 mt-0 text-center justify-content-center  align-items-center">
              <div className="homealltext col-lg-10 col-md-10 col-xs-12 ">
                <h1>
...
<div className="social-media   d-flex justify-content-center aling-items-center py-3">
  ...
  <div className="fb fs-5  mx-1 d-flex justify-content-center align-items-center "> <a href="https://www.facebook.com/profile.php?id=100024132496468"><i className="fa fa-facebook"></i></a></div>
                ...
                <a href="" className="linkbtnone"><button type="button" className="btn btnone ">
                  Downlode
                </button></a>

                <a href="" className="linkbtntwo"><button type="button" className="btn btntwo  text-dark mx-3">
                Talk
                </button></a>
          ...
          <div className="imagediv col-lg-5 col-md-5 order-first order-lg-last order-md-last  col-12 m-0 p-0 col-xs-tow ">
            <img
